...
void Snake::slideTo(Postion newPosition)
{
 ...
 *  // if snake eat cherry, number of cherries will increase
 * Args:
 *      // none
 * 
 * Returns:
...
void Snake::move(Direction direction)
{
    ...
    // If cherry > 0, cherry descrease one and growAtFront()
    if (cherry > 0) {
        /* YOUR CODE HERE */
        cherry--;
